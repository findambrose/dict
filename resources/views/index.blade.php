...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Maana | A USSD based dictionary</title>
   ...
   <body>
    ...
    <main id="main-section">
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".4s">A totally free USSD dictionary</span>
                                    <h1 data-animation="fadeInUp" data-delay=".6s">Get meanings without accessing the internet</h1>
                                    <p data-animation="fadeInUp" data-delay=".8s">We give you the ability to get the meaning and pronunnciation of any word through our USSD app. Simply dial *897# to get started. Enter your search term and let us handle the rest.</p>
                                    <!-- Slider btn -->
                                   <div class="slider-btns">
                                        <!-- Hero-btn -->
                                        <a data-animation="fadeInLeft" data-delay="1.0s" href="#" class="btn radius-btn">*897#</a>
                                        <!-- Video Btn -->
        ...
        <!-- Applic App Start -->
        <div class=" sky-blue applic-apps section-padding2">
